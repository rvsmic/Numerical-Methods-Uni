/*
Zadanie 3 Zaimplementuj metodę Laguerre’a służącą do znajdowania pierwiastków wielomianów (również zespolone).
*/
...
int main() {
    ...
    Complex x0 = 1;
    double eps = 1e-4;
    cout<<"Pierwiastek wielomianu = "<<laguerre(a, 4, x0, eps, 1000)<<endl;
    return 0;
}